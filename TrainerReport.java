...
import java.awt.Color;
   ...
   class trainerreports extends JFrame implements ActionListener
{
	JLabel l0,l1,l2;
	JButton b1,btnBack;
	JComboBox c1;
	...
	String ids;
	static JTable table;
	String[] columnnames={"Serial Number","Date","Trainer Id","Name","Experience","Address","Mobile Number"};
	String from;
	JFrame frame1;
	public trainerreports()
	{
		getContentPane().setBackground(Color.GRAY);
		l0=new JLabel("Fetching Trainer  Information");
     ...
     l1.setBounds(400,200,200,40);
           		...
           		try
		{
			...
			rs=st.executeQuery("select distinct(name) from trainer_table");
		...
		{
		  frame1=new JFrame("Trainer Information from Database Search");
		 ...
		 String i1,i4,i2,i3,i5,i6,i7;
		  try
		  {
		   PreparedStatement pst=con.prepareStatement("select * from trainer_table where name='"+from+"' " );
	           rs=pst.executeQuery();
		   int i=0;int i11;
		   while(rs.next())
		   {
