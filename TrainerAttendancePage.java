...
class TrainerAttendanceF extends JFrame implements ActionListener
{
	...
	public TrainerAttendanceF()
	{
		...
		lb1=new JLabel("Trainer Attendance");
		lb2=new JLabel("Trainer ID");
		lb3=new JLabel("Trainer Name");
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource()==b1)
		{
			try
			{
				...
				String q="insert into trainerattendance_table(Trainer_Id,Trainer_Name,A_Record,Date)values("+a+","+b+","+c+","+d+")";
