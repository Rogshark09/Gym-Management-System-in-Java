...
class StaffAttendanceF extends JFrame implements ActionListener
{
	...
	public StaffAttendanceF()
	{
		...
		lb1=new JLabel("Staff Attendance");
		lb2=new JLabel("Staff Member ID");
		lb3=new JLabel("Staff Member Name");
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource()==b1)
		{
			try
			{
				...
				String q="insert into staffattendance_table(Staff_Id,Staff_Name,A_Record,Date)values("+a+","+b+","+c+","+d+")";
