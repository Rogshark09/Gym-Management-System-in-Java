...
class UpdateTrainerF extends JFrame implements ActionListener
{
	...
	public UpdateTrainerF()
	{
		setTitle("Update Trainer Details");
		setVisible(true);
		setLayout(null);
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource()==b3)
		{
			...
			if(ae.getSource()==b1)
			{
				...
				String q="update trainer_table set name="+a+",experience="+b+",address="+c+",contact="+d+" where trainer_id="+Trainer_Id+"";
				System.out.println(q);
				st.executeUpdate(q);
				JFrame f2=new JFrame();
				JOptionPane.showMessageDialog(f2,"Trainer record Updated");
				setVisible(false);
				new HomepageF();
				st.close();
				con.close();
