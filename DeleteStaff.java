...
class DeleteStaffF extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource()==b3)
		{
			...
			if(ae.getSource()==b1)
			{
				...
				String q="delete from  staff_table  where staff_id="+Staff_Id+"";
				System.out.println(q);
				st.executeUpdate(q);
				JFrame f2=new JFrame();
				JOptionPane.showMessageDialog(f2," Staff Member record deleted");
				setVisible(false);
				new HomepageF();
				st.close();
				con.close();
